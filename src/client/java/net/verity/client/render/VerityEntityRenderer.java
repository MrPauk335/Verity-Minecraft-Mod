...
public class VerityEntityRenderer extends MobRenderer<VerityEntity, VerityEntityModel> {
    ...
    private static final ResourceLocation BLANK_TEXTURE = ResourceLocation.parse("verity:textures/entity/verity_face_blank.png");

    public VerityEntityRenderer(EntityRendererProvider.Context context) {
        super(context, new VerityEntityModel(context.bakeLayer(VerityModClient.MODEL_SPHERE_LAYER)), 0.3F);
